...
game:
  message:
    rank: Player {player} end at rank {rank}
    disconnect: Board {board} has been disconnected
    score:
      Scored : {points}
    winner:
      Winner : {winner}
  ...
  highest:
    name: Highest
    display: "{rounds} visits HighScore"
    error:
